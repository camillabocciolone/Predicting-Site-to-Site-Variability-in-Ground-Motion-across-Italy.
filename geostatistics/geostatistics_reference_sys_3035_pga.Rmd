...
bubble(ita, 'dS2S_SA_pga', do.log = TRUE, key.space = 'bottom') #negative value of ds2s means deamplification
...
hist(itaca$dS2S_SA_pga, breaks=16, col="grey", main='Histogram of dS2S T=0s', prob = TRUE, xlab = 'Zn')
...
xyplot(itaca$dS2S_SA_pga ~ itaca$vs30_from_profile, ylab = 'dS2S T=0s', xlab = 'Vs30 from profile') #Many NA not plotted
xyplot(itaca$dS2S_SA_pga ~ itaca$Vs30_Brunelli_simple, ylab = 'dS2S T=0s', xlab = 'Vs30 Brunelli')
xyplot(itaca$dS2S_SA_pga ~ itaca$Vs30_MORI_simple, ylab = 'dS2S T=0s', xlab = 'Vs30 MORI')
xyplot(itaca$dS2S_SA_pga ~ itaca$vseq_bedrock, ylab = 'dS2S T=0s', xlab = 'Vs30 equivalent')
xyplot(itaca$dS2S_SA_pga ~ itaca$Vs30_Brunelli_bilinear, ylab = 'dS2S T=0s', xlab = 'Vs30 Brunelli')
xyplot(itaca$dS2S_SA_pga ~ itaca$vs30_m_s_from_topography, ylab = 'dS2S T=0s', xlab = 'Vs30 from topography')
...
#VARIOGRAM ANALYSIS
#STATIONARY model
svgm <- variogram(dS2S_SA_pga ~ 1, ita) #1 const predictor i.e. spatially const mean
...
plot(variogram(dS2S_SA_pga ~ 1, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
#plot(variogram(dS2S_SA_pga~ 1, ita, cutoff = 1100, width = 1100/15),pch=19) #bdry found wiht min/mac(x,y)
#plot(variogram(dS2S_SA_pga~ 1, ita, cutoff = 1100, width = 1100/5),pch=19) #Meaning of cutoff distance and lag width
dev.off()

#VARIOGRAM model: reasonable to use spherical, beacuse have a ln increase in variogr. near 0 (with or without nugget)
v = variogram(dS2S_SA_pga ~ 1, ita)
...
g.tr <- gstat(formula = dS2S_SA_pga ~ 1, data = ita, model = v.fit, nmax = 20, set = list(gls=1))
...
g.tr = gstat(formula = dS2S_SA_pga ~ 1, data = ita, model = v.fit, nmax = 20, set = list(gls=1)) # non va
...
# g.tr <- gstat(formula = dS2S_SA_pga ~ 1, data = ita, model = v.fit, nmax = 30)
# lz.ok <- predict(g.tr, ita.grid, BLUE = FALSE)
...
FORMULA = formula(dS2S_SA_pga ~ Vs30_Brunelli_simple) # a single constant predictor
...
g.tr <- gstat(formula = dS2S_SA_pga ~ Vs30_Brunelli_simple, data = ita, model = v.fit, nmax = 30, set = list(gls=1))
...
# --- 6. PREDIZIONE ---
g.tr <- gstat::gstat(formula = dS2S_SA_pga ~ Vs30_Brunelli_simple,
...
cv <- krige.cv(
  formula   = dS2S_SA_pga ~ Vs30_Brunelli_simple,
  locations = ita,
  model     = v.fit
)
...
ita_clean=ita
ita=i
FORMULA = formula(dS2S_SA_pga ~ slope50_simple) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
g.tr <- gstat(formula = dS2S_SA_pga ~ slope50_simple, data = ita, model = v.fit, nmax = 30, set = list(gls=1))
...
g.tr <- gstat(formula = dS2S_SA_pga ~ slope50_simple,
...
# Calcola la cross-validation
cv <- krige.cv(
  formula   = dS2S_SA_pga ~ slope50_simple,
  locations = ita,
  model     = v.fit
)
...
FORMULA = formula(dS2S_SA_pga ~ x+y+ I(x*y)+slope50_simple ) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
g.tr <- gstat(
  formula = dS2S_SA_pga ~ x+y + I(x * y) + slope50_simple,
  data = ita,
  model = v.fit,
...
FORMULA <- dS2S_SA_pga ~  x*y + slope50_simple
...
ita_clean=ita
ita=i
FORMULA = formula(dS2S_SA_pga ~ Vs30_Brunelli_simple+slope50_simple) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
# 5. Crea il modello UK con tutte le covariate nel trend
g.tr <- gstat(
  formula = dS2S_SA_pga ~ x + y + I(x * y) + slope50_simple + Vs30_Brunelli_simple,
  data = ita,
  model = v.fit,
  nmax = 30, set = list(gls=1)
)
...
grid_spdf_clean@data$dS2S_SA_pga <- NULL

# Forza stesso CRS
proj4string(grid_spdf_clean) <- proj4string(ita)

# Universal Kriging
g.tr <- gstat(formula = dS2S_SA_pga ~ Vs30_Brunelli_simple + slope50_simple,
              data = ita, model = v.fit, set = list(gls=1))
...
```{r}
# --- 2. Definisci la formula con trend non-stazionario ---
FORMULA <- dS2S_SA_pga ~  Vs30_Brunelli_simple + slope50_simple
...
ita_clean=ita
ita=i
FORMULA = formula(dS2S_SA_pga ~ Vs30_MORI_simple) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
formula(dS2S_SA_pga \~ Vs30_MORI_simple+Vs30_Brunelli_simple+slope50_simple)
...
ita_clean=ita
ita=i
FORMULA = formula(dS2S_SA_pga ~ Vs30_MORI_simple+Vs30_Brunelli_simple+slope50_simple) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
FORMULA \<- dS2S_SA_pga \~ depth_to_bedrock + Vs30_Brunelli_simple + slope50_simple
...
FORMULA \<- dS2S_SA_pga \~ depth_to_bedrock
...
FORMULA = formula(dS2S_SA_pga ~ x*y+Vs30_Brunelli_simple) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
dS2S_SA_pga \~ (Vs30_Brunelli_simple)
...
dS2S_SA_pga \~ (1/slope50_simple) + sqrt(Vs30_Brunelli_simple)
...
FORMULA = formula(dS2S_SA_pga ~ (1/slope50_simple)  + sqrt(Vs30_Brunelli_simple)) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
(1/slope50_simple) + sqrt(Vs30_Brunelli_simple)+depth_to_bedrock
...
FORMULA = formula(dS2S_SA_pga ~ (1/slope50_simple)  + sqrt(Vs30_Brunelli_simple)+1/depth_to_bedrock ) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
FORMULA = formula(dS2S_SA_pga ~ (1/slope50_simple)  + sqrt(Vs30_Brunelli_simple)+x*y) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
```         
✅ LOOCV results per dS2S_SA_pga :
 RMSE     = 0.5023 
 MAE      = 0.389 
 ME       = -9e-04 
 SD       = 0.5038 
 LOO-MSE  = 0.2523 
 LOO-MSE (sci) = 2.523e-01 
```
...
FORMULA = formula(dS2S_SA_pga ~ sqrt(slope50_simple)  + sqrt(Vs30_Brunelli_simple)) # a single constant predictor
v= variogram(FORMULA, data=ita)
# v0= variogram(FORMULA, data=df0)
plot(v, main = 'Variogram', pch=19)
plot(variogram(FORMULA, ita, alpha = c(0, 45, 90, 135)),pch=19) #They look similar, i.e. have isotropy (and most likely also stationarity)
...
media degli mse per pga 0.2575

media di sd per pga 0.507133

media degli mse per 1 s 0.3206

media di sd per 1 s 0.5607
